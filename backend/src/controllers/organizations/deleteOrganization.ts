...
async function deleteOrganization(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const deletedOrganization: any = await organizationService.deleteOrganization(organization._id);
        return apiResponse(
            res,
            ResponseType.SUCCESS,
            StatusCode.OK,
            ResponseCode.SUCCESS,
            deletedOrganization as object
        );
    }
    catch (error) {
        return apiResponse(
