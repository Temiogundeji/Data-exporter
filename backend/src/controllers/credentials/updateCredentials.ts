...
async function updateCredentials(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const updatedCredential: any = await credentialService.updateCredential(credential._id, req.body);
        return apiResponse(
            res,
            ResponseType.SUCCESS,
            StatusCode.OK,
            ResponseCode.SUCCESS,
            updatedCredential as object
        );
    }
    catch (error) {
        return apiResponse(
